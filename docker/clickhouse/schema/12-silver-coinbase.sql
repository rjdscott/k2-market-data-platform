-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- Silver Layer: Coinbase → Unified Schema (v2 pattern)
-- Source: k2.bronze_trades_coinbase (v2 normalized schema)
-- Target: k2.silver_trades (unified multi-exchange schema)
-- Pattern: identical to bronze_binance_to_silver_mv / bronze_kraken_to_silver_mv
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
-- Normalizations performed:
-- - symbol: "BTCUSD" → canonical_symbol="BTC/USD" (all Coinbase pairs are USD)
-- - price/quantity: Decimal(18,8) → Decimal128(8) for higher precision
-- - ingestion_timestamp: DateTime → DateTime64(6)
...
-- Verify normalization (all 3 exchanges):
