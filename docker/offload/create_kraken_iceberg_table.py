...
print("\n" + "="*80)
print("Creating Iceberg Table: demo.cold.bronze_trades_kraken")
print("="*80)

# Drop if exists
spark.sql("DROP TABLE IF EXISTS demo.cold.bronze_trades_kraken")
...
print("✅ Created table: demo.cold.bronze_trades_kraken")

# Verify
result = spark.sql("DESCRIBE TABLE demo.cold.bronze_trades_kraken")
print("\nTable schema:")
