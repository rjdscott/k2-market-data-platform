...
- **Current Phase**: [Phase 1 Progress](./phases/phase-1-portfolio-demo/PROGRESS.md)
- **Decision Log**: [Architectural Decisions](./phases/phase-1-portfolio-demo/DECISIONS.md)
...
**Current Phase**: [Phase 1 - Portfolio Demo](./phases/phase-1-portfolio-demo/)
- [Implementation Plan](./phases/phase-1-portfolio-demo/IMPLEMENTATION_PLAN.md) - 16-step plan
- [Progress Tracking](./phases/phase-1-portfolio-demo/PROGRESS.md) - Current status
- [Decisions Log](./phases/phase-1-portfolio-demo/DECISIONS.md) - Phase 1 ADRs
...
### Starting New Work
1. Check [Current Phase Status](./phases/phase-1-portfolio-demo/STATUS.md)
2. Review relevant [Implementation Step](./phases/phase-1-portfolio-demo/steps/)
...
3. Create ADR in [DECISIONS.md](./phases/phase-1-portfolio-demo/DECISIONS.md)
