...
**Current Phase**: `phase-1-portfolio-demo/`
...
**Claude Should**:
1. Read `docs/phases/phase-1-portfolio-demo/steps/step-05-configuration.md`
2. Implement the code per the step
3. Update the step file:
   - Change Status from ⬜ to ✅
   - Add actual time taken
   - Fill in Notes & Decisions section
4. Update `docs/phases/phase-1-portfolio-demo/PROGRESS.md`:
   - Update "Detailed Progress" section for Step 5
   - Update completion percentage
5. If architectural decision made → Add to `docs/phases/phase-1-portfolio-demo/DECISIONS.md`
...
**Files Updated**:
- `docs/phases/phase-1-portfolio-demo/steps/step-05-configuration.md`
- `docs/phases/phase-1-portfolio-demo/PROGRESS.md`
- `docs/phases/phase-1-portfolio-demo/DECISIONS.md` (if applicable)
...
- [Decision #005](../phases/phase-1-portfolio-demo/DECISIONS.md#decision-005)
...
### Directory Names
- Use kebab-case: `data-guarantees/`, `runbooks/`, `phase-1-portfolio-demo/`
...
**Claude Workflow**:
1. Read: `docs/phases/phase-1-portfolio-demo/steps/step-06-kafka-producer.md`
2. Implement code in `src/k2/ingestion/producer.py`
3. Write tests in `tests/unit/test_producer.py`
4. Update `docs/phases/phase-1-portfolio-demo/steps/step-06-kafka-producer.md`:
   - Status: ⬜ → ✅
   - Actual Time: 5 hours
   - Notes: "Implemented with idempotent config, added retry logic"
5. Update `docs/phases/phase-1-portfolio-demo/PROGRESS.md`:
