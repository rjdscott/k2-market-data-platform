...
| [014](ADR-014-spark-based-iceberg-offload.md) | Spark-based Iceberg offload | Accepted — Implemented — **superseded by [ADR-022](ADR-022-exactly-once-via-snapshot-offsets.md)** | PySpark instead of a custom Kotlin service; 15-min cycle; 236 K rows/s measured |
...
| [017](ADR-017-iceberg-maintenance-pipeline.md) | Iceberg daily maintenance pipeline | Accepted — Implemented; watermark + audit stores **superseded by [ADR-022](ADR-022-exactly-once-via-snapshot-offsets.md)** for the lake | Nightly compact → expire → audit; audit gate fails the run on missing data |
...
| [ADR-014](ADR-014-spark-based-iceberg-offload.md) | [ADR-022](ADR-022-exactly-once-via-snapshot-offsets.md) | the offload mechanism and its PostgreSQL watermark |
| [ADR-017](ADR-017-iceberg-maintenance-pipeline.md) | [ADR-022](ADR-022-exactly-once-via-snapshot-offsets.md) | the PostgreSQL audit store, for the lake; the compact → expire → audit ordering is kept |
...
| [ADR-009](ADR-009-medallion-in-clickhouse.md) | [ADR-025](ADR-025-clickhouse-derived-hot-tier.md) | medallion-in-ClickHouse and offload-from-ClickHouse; the Gold/OHLCV model goes to ADR-026 |
