...
| Apache Spark | 3.5.5 (`tabulario/spark-iceberg:3.5.5_1.8.1`) | Batch only — reads ClickHouse over JDBC, appends to Iceberg. No streaming jobs. v2 offload verified working on this base (2,526 rows offloaded) | [ADR-006](../adr/ADR-006-spark-batch-only.md), [ADR-014](../adr/ADR-014-spark-based-iceberg-offload.md) |
