...
### Implementation
- [Step 9: DuckDB Query Engine](../phases/phase-1-single-node-equities/steps/step-09-query-engine.md)
- [Step 10: Replay Engine](../phases/phase-1-single-node-equities/steps/step-10-replay-engine.md)
- [Step 11: Query CLI](../phases/phase-1-single-node-equities/steps/step-11-query-cli.md)
- [Architectural Decisions](../phases/phase-1-single-node-equities/DECISIONS.md) - Decision #017, #018
