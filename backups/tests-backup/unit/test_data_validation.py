"""Data validation tests-backup using Pandera.
...
Run: pytest tests-backup/unit/test_data_validation.py -v
"""
...
class TestBatchValidation:
    ...
    def test_large_trade_batch_validation(self):
        ...
        # Generate 100 valid trades (reduced for memory efficiency in parallel tests-backup)
        trades = []
        for i in range(100):
            trades.append(
                {
    ...
    def test_large_quote_batch_validation(self):
        ...
        # Generate 100 valid quotes (reduced for memory efficiency in parallel tests-backup)
        quotes = []
        for i in range(100):
            bid = 3000.0 + i * 0.01
