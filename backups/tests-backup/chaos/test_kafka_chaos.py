...
These tests-backup validate the platform's resilience to Kafka-related faults.

Usage:
    pytest tests-backup/chaos/test_kafka_chaos.py -v -m chaos
"""
...
# Mark all tests-backup in this file as chaos tests-backup with 60s timeout
...
class TestKafkaBrokerFailure:
    ...
    @pytest.mark.skip(reason="Consumer fixture needs refactoring for chaos tests-backup")
