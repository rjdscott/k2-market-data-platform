...
pytest tests/performance/test_producer_throughput.py --benchmark-only
pytest tests/performance/test_writer_throughput.py --benchmark-only
...
pytest tests/performance/ --benchmark-only --no-cov

# Use optimized Python
python -O -m pytest tests/performance/ --benchmark-only
```
...
py-spy record --format speedscope -o profile.json -- \
    pytest tests/performance/test_producer_throughput.py

# Memory profiling
pytest tests/performance/ --memprof

# Line-by-line profiling
kernprof -l tests/performance/test_producer_throughput.py
