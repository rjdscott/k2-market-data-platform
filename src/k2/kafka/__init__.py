...
class TopicNameBuilder:
    ...
    def __init__(self, config_path: Optional[Path] = None):
        ...
        if config_path is None:
            ...
            config_path = Path(__file__).parent.parent.parent.parent / "config" / "kafka" / "topics.yaml"
    ...
    def get_topic_config(
        ...
        schema_subject = subject_pattern.format(
    ...
    def list_topics_for_exchange(self, asset_class: str, exchange: str) -> List[str]:
        ...
        return sorted([
            self.build_topic_name(asset_class, data_type, exchange)
            for data_type in DataType
        ])
    ...
    def parse_topic_name(self, topic_name: str) -> Optional[Dict[str, str]]:
...
_topic_builder: Optional[TopicNameBuilder] = None


def get_topic_builder(config_path: Optional[Path] = None) -> TopicNameBuilder:
