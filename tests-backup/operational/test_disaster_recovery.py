"""Operational tests-backup for disaster recovery runbooks.

These tests-backup validate that operational runbooks work as documented by simulating
...
Usage:
    pytest tests-backup/operational/test_disaster_recovery.py -v --timeout=300
"""
...
@pytest.mark.timeout(300)  # 5 minutes max for disaster recovery tests-backup
