...
Run:
    pytest tests-backup/integration/test_e2e_full_pipeline.py -v -s -m integration

Note: These tests-backup may take several minutes as they involve real service integration.
"""
...
Run Tests:
# All E2E tests-backup
pytest tests-backup/integration/test_e2e_full_pipeline.py -v -s -m integration

# Quick tests-backup (without slow tests-backup)
pytest tests-backup/integration/test_e2e_full_pipeline.py -v -m "integration and not slow"

# Specific test class
pytest tests-backup/integration/test_e2e_full_pipeline.py::TestProducerToKafka -v

# With detailed logging
pytest tests-backup/integration/test_e2e_full_pipeline.py -v -s --log-cli-level=INFO

Expected Results:
- Service availability tests-backup: 100% pass
- Producer → Kafka tests-backup: 100% pass
- Iceberg storage tests-backup: 100% pass if infrastructure initialized
- API tests-backup: 100% pass if API server running
