"""Unit tests-backup for API request body size limit middleware.
...
class TestRequestSizeLimitMiddleware:
    ...
    def test_missing_content_length_allowed(self, app_with_size_limit):
        ...
        # Note: TestClient adds Content-Length automatically, so this tests-backup normal behavior
...
class TestRequestSizeLimitIntegration:
    """Integration tests-backup for request size limit middleware."""
